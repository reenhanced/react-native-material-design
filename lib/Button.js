...
export default class Button extends Component {
    ...
    render() {
        ...
        const { text, value, theme, primary, overrides, disabled, loading, raised, onPress, onLongPress } = this.props;
        ...
        if (disabled || loading) {
            return (
                ...
                >
                    <ActivityIndicator animating={this.props.loading} style={styles.spinner} color={this.props.activityIndicatorColor} />
                    {!loading &&
        ...
        } else if (!isCompatible('TouchableNativeFeedback')) {
            return (
                <Ripple
