...
export default class Button extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
      return nextProps.loading !== this.props.loading || nextProps.disabled !== this.props.disabled;
    }
    ...
    _renderInnerTextAndroid = (textStyle) => {
        ...
        return (
            <Text style={[TYPO.paperFontButton, (textStyle || this.props.textStyle), styles.text]}>
    ...
    _renderInnerText = (textStyle) => {
        if (Button.isAndroid) {
            return this._renderInnerTextAndroid(textStyle);
        } else {
            return this._renderInnerTextiOS(textStyle);
        }
    }

    render() {
        const { elevation } = this.state;
        const { text, value, theme, primary, overrides, disabled, loading, raised, style, onPress, onLongPress } = this.props;
        ...
        if (!Button.isAndroid) {
            return (
                <Ripple
                    ...
                    onLongPress={!(disabled || loading) ? onLongPress : null}
                    style={[
                        styles.button,
                        buttonStyle, {
                            backgroundColor: buttonStyle && buttonStyle.backgroundColor,
            ...
            return (
                ...
                >
                    <View style={[
                        ...
                        disabled && this.props.disabledStyle ]}
                    >
                        {this._renderInnerTextAndroid(textStyle)}
                    </View>
                </TouchableNativeFeedback>
            );
        }
